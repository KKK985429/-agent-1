export default {
  ...
  newUserGuide: {
    ...
    steps: {
      welcome: {
        title: 'Добро пожаловать в AIP-wisdom',
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и AIP-wisdom автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.',
      },
      chat: {
  ...
  settings: {
    ...
    weknoraCloud: {
      title: 'AIP-wisdom Cloud',
      description: 'Настройте учётные данные APPID и APPSECRET для AIP-wisdom Cloud. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные AIP-wisdom Cloud истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения AIP-wisdom Cloud',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения AIP-wisdom Cloud',
      ...
      usageSteps: '1. Сохраните APPID и APPSECRET\n2. Добавьте chat, embedding, rerank и vlm в разделе «Облачные модели» ниже\n3. Парсинг: Настройки БЗ → Движок парсинга → AIP-wisdom Cloud',
      fillRequired: 'Заполните APPID и APPSECRET',
      saveSuccess: 'Учётные данные сохранены',
      saveFailed: 'Не удалось сохранить данные',
      credentialConfigured: 'Учётные данные AIP-wisdom Cloud настроены.',
      credentialExpired: 'Данные истекли. Перенастройте.',
      credentialUnconfigured: 'Учётные данные AIP-wisdom Cloud не настроены. Заполните APPID и APPSECRET.',
      checkingStatus: 'Проверка статуса...',
      goToSettings: 'Перейти в настройки',
      modelHintConfigured: 'Учётные данные AIP-wisdom Cloud настроены. Поддерживаемые модели см. в',
      modelHintDocsLink: 'документации API',
      modelsSection: {
        title: 'Облачные модели',
        descReady: 'Зарегистрируйте четыре стандартные модели AIP-wisdom Cloud для чата, поиска, реранкинга и зрения.',
      ...
      addModelsDisplayName: {
        chat: 'AIP-wisdom Cloud Chat',
        embedding: 'AIP-wisdom Cloud Embedding',
        rerank: 'AIP-wisdom Cloud ReRank',
        vllm: 'AIP-wisdom Cloud Vision',
      },
    },
...
/example\.(net|org)/`,
  ...
  initialization: {
    title: 'Инициализация',
    welcome: 'Добро пожаловать в AIP-wisdom',
  ...
  auth: {
    ...
    firstTime: 'Впервые в AIP-wisdom?',
  ...
  createChat: {
    title: 'Привет, я AIP-wisdom — ваши знания всегда под рукой',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'AIP-wisdom Cloud',
          desc: 'Парсинг документов через AIP-wisdom Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
