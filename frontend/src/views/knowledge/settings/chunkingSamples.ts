...
const MARKDOWN_SAMPLE = `# AIP-wisdom 知识框架

AIP-wisdom 是一个基于 LLM 的开源企业知识框架，集 RAG 问答、ReAct 智能体、Wiki 知识图谱于一体。本文介绍其设计动机、架构与典型用法。

## 设计动机

企业内部知识散落在 Confluence、飞书、Notion、Git 仓库等多种系统，传统全文检索难以理解语义，单一 LLM 又缺少可信赖的上下文来源。AIP-wisdom 的目标是：
...
\`\`\`bash
git clone https://github.com/KKK985429/-agent-1.git aip-wisdom && cd aip-wisdom
...
const FAQ_SAMPLE = `# AIP-wisdom 部署与使用 FAQ
