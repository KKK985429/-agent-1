...
const troubleshootingDocsURL =
  'https://github.com/KKK985429/-agent-1/blob/main/docs/migration-troubleshooting.md'
...
const reportIssueURL = computed(() => {
  const base = 'https://github.com/KKK985429/-agent-1/issues/new'
  ...
  if (errMsg) {
    const body = [
      '### Environment',
      `- AIP-wisdom version: ${systemInfo.value?.version || 'unknown'}`,
